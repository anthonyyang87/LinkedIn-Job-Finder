...
def search_jobs(keywords, location_name, listed_at, companies):
    print(
        f"*********Searching Jobs with User Defined Parameters********** \nKeyword: {keywords}, \nLocation:  {location_name}, \nListed at: {listed_at}, \nCompanies ID: {companies}")
    print("Searching.............")
    jobs = linkedin.search_jobs(
        keywords=keywords, location_name=location_name, listed_at=listed_at, companies=companies)
...
def test_get_multiple_companies_urn_id(companies: list):
    print(f"Test get {companies}urn_id: ",
          get_multiple_companies_urn_id(companies))
...
def test_search_jobs(keywords, location_name, listed_at, companies):
    jobs = linkedin.search_jobs(
        keywords=keywords, location_name=location_name, listed_at=listed_at, companies=companies)
    print(
        f"Test search jobs using keyword {keywords}, \nlocation {location_name}, \nlisted at {listed_at}, \ncompanies {companies}: \n", jobs)
    return jobs
...
def main():
    ...
    write_to_file(summarized_jobs_details,
                  "../data/jobs/jobs_search_summary.json")
